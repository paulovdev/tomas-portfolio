    ...
    <>
      ...
      >
        ...
        <div className="flex content-start justify-start max-md:hidden">
          <Link
            to="/"
            className={`text-[clamp(1em,5vw,1em)] max-sm:text-clamp(.85em,3vw,1em)] text-s! font-medium tracking-[-0.03em] ${isActive(
              "/"
            )}`}
          >
            T—ML
        ...
        <div className="flex justify-start gap-1 max-md:hidden">
          <Link
            to="/works"
            className={`text-[clamp(1em,5vw,1em)] max-sm:text-clamp(.85em,3vw,1em)] font-medium tracking-[-0.03em] ${isActive(
              "/works"
            )}`}
          >
            Work,
