        ...
        <div className="flex justify-center">
          {isWorkDetail && project ? (
            <div className="w-full flex items-center gap-1">
              <span className=" text-[.9em] max-md:text-[1em]  max-md:text-[1em] text-s font-semibold tracking-[-0.03em]">
                {project.title}
              </span>
              <span className=" text-[.9em] max-md:text-[1em]  max-md:text-[1em] text-s font-semibold tracking-[-0.15em]">
                —
              </span>
              <button
                onClick={() => setProjectModal(true)}
                className=" text-[.9em] max-md:text-[1em]  max-md:text-[1em] text-s font-semibold tracking-[-0.03em] cursor-pointer"
              >
                Information
              </button>
            </div>
