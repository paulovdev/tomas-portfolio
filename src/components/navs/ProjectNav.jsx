  ...
  `}
      ...
      `}
        ...
        <div className="flex justify-start gap-1 max-md:hidden">
          <Link
            to="/works"
            className={`text-[clamp(.75em,3vw,1em)] text-s font-medium tracking-[-0.03em]
        ...
        <div className="flex justify-center ">
          {isWorkDetail && project ? (
            <div className="w-full flex items-center gap-1">
              <span className="text-[clamp(.75em,3vw,1em)] text-s font-semibold tracking-[-0.03em]">
                {project.title}
              </span>
              <span className="text-[clamp(.75em,3vw,1em)] text-s font-semibold  tracking-[-0.15em]">
                —
              </span>

              <button
                onClick={() => setProjectModal(true)}
                className="text-[clamp(.75em,3vw,1em)] text-s font-semibold tracking-[-0.03em] cursor-pointer"
              >
                Information
              </button>
            </div>
