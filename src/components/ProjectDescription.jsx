      ...
      >
        ...
        >
          <nav className="mb-20 flex items-center justify-between">
            <p
              className="text-p text-[clamp(1em,5vw,1em) max-sm:text-clamp(.85em,3vw,1em)] font-semibold tracking-[-0.03em] cursor-pointer"
            ...
            <div className="w-full flex items-start justify-between">
              ...
              <ul>
                <li className="flex items-center gap-2">
                  <p className="text-p/75 text-[clamp(1em,5vw,1em) max-sm:text-clamp(.85em,3vw,1em)] font-semibold tracking-[-0.03em] ">
                    Year:
                  </p>
                  <p className="text-p text-[clamp(1em,5vw,1em) max-sm:text-clamp(.85em,3vw,1em)] font-semibold tracking-[-0.03em] ">
                    {project.year}
