    ...
    >
      ...
      >
        <div className="mb-12 w-full flex items-center justify-between">
          <p className="text-p  text-[.9em] max-md:text-[1em]   font-medium tracking-[-0.03em]">
            Let's talk
          </p>
          <button
            onClick={() => setShowNewsletter(false)}
            className="text-p  text-[.9em] max-md:text-[1em]   font-medium tracking-[-0.03em]"
          >
            Close
          </button>
        </div>
        ...
        >
          <div className="flex flex-col w-full h-full">
            <input
              ...
              className="mb-4 w-full border-b border-p/25 text-p  text-[.9em] max-md:text-[1em]   font-medium tracking-[-0.03em] bg-transparent outline-none placeholder:text-p"
            />
