      ...
      >
        <div className="w-full grid grid-cols-4">
          ...
          <div className="flex flex-col items-start col-span-3">
            <p className="text-p text-[.9em]  max-lg:text-[.93em]   font-semibold tracking-[-0.03em]">
              Page not found :&#40;
            </p>
            <p className="text-p text-[.9em]  max-lg:text-[.93em]   font-semibold tracking-[-0.03em]">
            ...
            <p className="text-p text-[.9em]  max-lg:text-[.93em]   font-semibold tracking-[-0.03em]">
              ...
              <Link
                to={"/"}
                className="text-p text-[.9em]  max-lg:text-[.93em]   font-semibold tracking-[-0.03em] underline"
              >
                homepage
              </Link>
            </p>
