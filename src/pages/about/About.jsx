    ...
    <>
      ...
      <section className="relative h-full px-4 py-24 bg-s text-p">
        ...
        <div className="grid grid-cols-4 mb-25 pt-8 max-md:grid-cols-1">
          <p className="mb-6 text-p text-[clamp(.75em,3vw,1em)] font-semibold tracking-[-0.03em]">
            Services
          </p>
          {/* MOBILE */}
          <div className="max-md:grid max-md:grid-cols-3 hidden">
            {Object.entries(services).map(([category, items]) => (
              <div key={category}>
                <p className="mb-6 border-b border-black/10 text-p text-[clamp(.75em,3vw,1em)] font-semibold tracking-[-0.03em]">
                  {category}
                </p>
